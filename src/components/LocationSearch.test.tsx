...
const mockFetchGeoLocFromWeatherAPI = WeatherAPI.fetchGeoLocFromWeatherAPI as jest.Mock;
...
describe("LocationSearch", () => {
  ...
  it("renders input and suggestions correctly", async () => {
    mockFetchGeoLocFromWeatherAPI.mockResolvedValue([
      { id: 1, name: "London", region: "England", country: "UK", lat: 51.51, lon: -0.13 },
      { id: 2, name: "Londonderry", region: "Northern Ireland", country: "UK", lat: 54.997, lon: -7.307 },
    ]);
